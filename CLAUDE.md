...
5. ~~Matching service (GEOSEARCH + Lua-script pending-offer claim + retry logic)~~ — done, including accept/reject endpoints and the TTL polling sweep. Gateway proxy for `/offers/*` still outstanding (not yet reachable through the Gateway).
